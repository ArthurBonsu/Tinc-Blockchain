...
set CLASSPATH=%APP_HOME%\lib\core.jar;%APP_HOME%\lib\utilities.jar;%APP_HOME%\lib\list.jar;%APP_HOME%\lib\commons-text-1.12.0.jar;%APP_HOME%\lib\commons-lang3-3.14.0.jar


@rem Execute core
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CORE_OPTS%  -classpath "%CLASSPATH%" org.example.app.App %*
